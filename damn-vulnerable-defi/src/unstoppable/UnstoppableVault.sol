...
contract UnstoppableVault is IERC3156FlashLender, ReentrancyGuard, Owned, ERC4626, Pausable {
        ...
        returns (bool)
    {
        ...
        // ! vulnerability: the below check can be triggered by sending tokens directly to the vault, which will cause the flashloan to fail and the vault to be paused
