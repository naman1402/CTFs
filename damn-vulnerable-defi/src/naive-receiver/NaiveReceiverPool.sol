...
contract NaiveReceiverPool is Multicall, IERC3156FlashLender {
    ...
    function _msgSender() internal view override returns (address) {
        // ! forwarder can impersonate any address by controlling the last 20 bytes of the message data
        // When call comes from a TrustedForwarder, it reads the alst 20 bytes of calldata as the sender.standard ERC-2771 meta-txns pattern
